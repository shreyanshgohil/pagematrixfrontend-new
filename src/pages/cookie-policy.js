...
const CookiePolicy = () => {
  const cookieTypes = [
    ...
    },
    {
      ...
      purpose: "Website performance, user behavior analysis and improvements",
    ...
    },
    {
      ...
      purpose:
        "Personalized advertising, marketing campaigns and user preferences",
    ...
    },
    {
      ...
      purpose:
        "User preferences, language settings and personalized experience",
      retention: "Up to 1 year",
      required: false,
    },
  ];
  ...
  const cookieFeatures = [
    {
      ...
      description:
        "All cookies are handled in compliance with data protection regulations and privacy standards.",
    },
    {
      icon: <FaGlobe />,
      title: "Global Standards",
      description:
        "We follow international cookie policies and best practices for user privacy.",
    },
    {
      icon: <FaCog />,
      title: "User Control",
      description:
        "You have full control over which cookies you accept and can change your preferences anytime.",
    },
    {
      icon: <FaInfoCircle />,
      title: "Transparency",
      description:
        "We provide clear information about what cookies we use and why we use them.",
    },
  ];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:pt-8 lg:py-16">
              <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                ...
                <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-white/90 backdrop-blur-sm rounded-full shadow-lg border border-white/20 mb-6 sm:mb-8">
                  <FaCookieBite className="h-4 w-4 sm:h-5 sm:w-5 text-brand-theme" />
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 sm:mb-8">
                  <span className="inline-block">Cookie</span>{" "}
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start gap-4 sm:gap-6">
                      <div className="flex-shrink-0">
                        <div className="flex items-center gap-4 sm:gap-6">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-brand-theme to-brand-theme-600 rounded-xl sm:rounded-2xl flex items-center justify-center text-white text-lg sm:text-xl group-hover:scale-110 transition-transform duration-300">
                            {cookie.icon}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
                          <h3 className="text-xl sm:text-2xl font-bold text-brand-blue-800 group-hover:text-brand-theme transition-colors duration-300">
                            {cookie.title}
                          </h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                          <div>
                            <h4 className="text-sm font-semibold text-brand-blue-800 mb-1">
                              Purpose:
                            </h4>
            ...
            <div className="container--boxed px-4 sm:px-6 lg:px-8 text-center">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-base sm:text-lg lg:text-xl text-brand-gray-500 mb-6 sm:mb-8">
                  ...
                  use cookies, please don't hesitate to contact us.
                </p>
