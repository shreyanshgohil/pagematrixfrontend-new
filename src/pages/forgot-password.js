...
const ForgotPassword = () => {
  ...
  const features = [
    ...
    },
    {
      icon: <FaRocket />,
      title: "Quick Process",
      description: "Get your reset link in minutes and regain access instantly",
    },
    {
      icon: <FaTachometerAlt />,
      title: "No Downtime",
      description:
        "Continue using our PageSpeed tools while resetting your password",
    },
  ];
  ...
  return (
    <>
      <SEO
        title="Forgot Password - PageSpeed Performance Tool | Reset Your Password"
        description="Reset your PageSpeed performance tool password securely. Get back to optimizing your website performance with our comprehensive analysis tools."
        keywords="forgot password, reset password, PageSpeed account recovery, password reset, account access, performance tool login"
        url="/forgot-password"
      />
              ...
              <div className="text-white space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-white/90 max-w-lg leading-relaxed">
                    ...
                    link to reset your password and get back to optimizing
                    performance.
                  </p>
                </div>
          ...
          <div className="container--boxed px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-brand-gray-600 max-w-3xl mx-auto">
                Your account security is our top priority. We use
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center group bg-white rounded-2xl p-8 shadow-lg border border-brand-gray-200 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-brand-gray-600">
                  Get your reset link in minutes and regain access to your
                  PageSpeed tools instantly
                </p>
              </div>
              ...
              <div className="text-center group bg-white rounded-2xl p-8 shadow-lg border border-brand-gray-200 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-brand-gray-600">
                  Continue using our PageSpeed tools while resetting your
                  password
                </p>
              </div>
            </div>
