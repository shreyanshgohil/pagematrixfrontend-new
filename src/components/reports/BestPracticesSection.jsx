      ...
      <div className="bg-white rounded-2xl shadow-xl border border-brand-gray-400/50 p-8 mb-8 backdrop-blur-sm">
        ...
        <div className="text-center py-8">
          <p className="text-brand-gray-500 font-medium">
            Best practices data not available in this report. Enable best
            practices category in Lighthouse to see this data.
          </p>
        </div>
      </div>
    );
        ...
        {bestPracticesData.lighthouseResult.categories["best-practices"]
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {bestPracticesData.lighthouseResult.categories[
                "best-practices"
              ].auditRefs
                .slice(0, 10)
                .map((auditRef, index) => {
                  const audit =
                    bestPracticesData.lighthouseResult?.audits?.[auditRef.id];
