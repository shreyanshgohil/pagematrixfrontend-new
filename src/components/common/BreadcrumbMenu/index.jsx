          ...
          {items.map((item, index) => (
            <React.Fragment key={index}>
              ...
              {item.href && item.href !== "#" ? (
                <Link
                  href={item.href}
                  className="text-brand-gray hover:text-brand-theme border-b border-transparent hover:border-b-brand-theme text-xs sm:text-sm"
                >
                  {item.label}
                </Link>
              ) : (
                <span className="text-brand-gray text-xs sm:text-sm">
                  {item.label}
                </span>
              )}
            </React.Fragment>
